...
- **Keeping `the-two-crossings.md` standalone under an umbrella page.** Rejected for one-door navigation: the crossings are a chapter of the estate story, not a separate estate.
