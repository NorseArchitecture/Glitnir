...
2. **Abiding by the Aesir** — implementing Abstractions' declared contracts: the plugin interfaces, `I{Context}Api`, the repository contract family, the event/command shapes, the principal contract (`Norse.Abstractions.Identity`).
